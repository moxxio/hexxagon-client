...
public class MessageReceiver {
	...
	private void receiveAvailableLobbiesMessage(AvailableLobbies message) {
		ArrayList<Lobby> availableLobbies = (ArrayList<Lobby>) message.availableLobbies;
	...
	private void receiveLobbyJoinedMessage(LobbyJoined message) {
		lobbyHandler.lobbyJoined(message.userId, message.lobbyId);
	...
	private void receiveLobbyStatusMessage(LobbyStatus message) {
		lobbyHandler.lobbyStatusUpdate(message.lobby.isClosed, message.lobby.playerOne, message.lobby.playerTwo, message.lobby.playerOneUserName, message.lobby.playerTwoUserName);
	}
	
	private void receiveGameStartedMessage(GameStarted message) {
		// initialize gameHandler
		gameHandler.gameStarted(message.userId, message.gameId, message.creationDate);
