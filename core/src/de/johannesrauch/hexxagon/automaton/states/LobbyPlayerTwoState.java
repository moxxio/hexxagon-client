...
/**
 * This class represents the in lobby state with the client as player two of the finite-state machine of the client.
 * For an overview of the states of the finite-state machine, see docs/fsm/fsm.pdf.
 *
 * @author Johannes Rauch
 */
public class LobbyPlayerTwoState implements State {

    private final Logger logger = LoggerFactory.getLogger(LobbyPlayerTwoState.class);

    /**
     * This method handles all possible state transition from the in lobby with the client as player two state.
     *
