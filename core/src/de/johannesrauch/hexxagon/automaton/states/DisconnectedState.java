...
/**
 * This class represents a disconnected state of the finite-state machine of the client.
...
public class DisconnectedState implements State {
    ...
    private final Logger logger = LoggerFactory.getLogger(DisconnectedState.class);

    /**
     * This method handles all possible state transition from the discondnected state.
     *
